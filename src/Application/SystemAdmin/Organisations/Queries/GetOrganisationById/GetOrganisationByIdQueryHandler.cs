    ...
    : IQueryHandler<GetOrganisationByIdQuery, OrganisationListDto>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var dto = new OrganisationListDto
        {
            ...
            MonthlyQuotaLimit = organisation.MonthlyQuotaLimit,
            MonthlyQuotaUsed = organisation.MonthlyQuotaUsed,
            MonthlyQuotaRemaining = Math.Max(0, organisation.MonthlyQuotaLimit - organisation.MonthlyQuotaUsed),
