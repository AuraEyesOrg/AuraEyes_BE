...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260426214404_AddClinicFeedback")]
    partial class AddClinicFeedback
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Consultation.OphthalmologistFeedback", b =>
                {
                    ...
                    b.HasIndex("PatientId", "ConsultationSessionId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.Consultation.WebsiteFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("WebsiteFeedback", null, t =>
                        {
                            t.HasCheckConstraint("CK_WebsiteFeedback_Rating", "rating >= 1 AND rating <= 5");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Platform.WorkloadRequirement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EmploymentType", "PeriodType")
                        .IsUnique()
                        .HasDatabaseName("UX_WorkloadRequirements_Employment_Period")
                        .HasFilter("\"IsDeleted\" = false");

                    b.ToTable("WorkloadRequirements", null, t =>
                        {
                            t.HasCheckConstraint("CK_WorkloadRequirements_RequiredHours_NonNegative", "\"RequiredHours\" >= 0");
                        });

                    b.HasData(
                        new
                        {
                            Id = new Guid("4387bc41-31be-4d0e-a5a4-30bd95c79112"),
                        ...
                        new
                        {
                            Id = new Guid("bc5004a0-a6ce-484a-a2e5-8af7559f95fb"),
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            CreatedBy = "system",
                            EmploymentType = "FullTime",
                            IsDeleted = false,
