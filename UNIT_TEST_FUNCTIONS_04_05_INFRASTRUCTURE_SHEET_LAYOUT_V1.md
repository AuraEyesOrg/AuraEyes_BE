...
2. Đọc **Condition Matrix** để nắm ý chung (phần sau `->` là kết quả _tóm tắt_).
...
_All UTCIDs: `AuthServiceTests.RegisterPatientAsync_WhenDependenciesMissing_ShouldReturnFailure` (10× `InlineData`) — same assertion._
